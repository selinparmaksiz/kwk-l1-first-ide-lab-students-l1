...
def calculater
  ...
  puts "Welcome to our music calculater that calculates the average amount of hours of music listened to in your lifetime.".light_red

    puts "Please enter the current month (format as a number)".red
    ...
    puts totalmusichours.to_s + " hours of music listened to so far in your lifetime".cyan
  end
